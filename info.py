...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001543768923').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Shoaib2005:iamshoaib7@cluster0.ycy9xnh.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001726130002'))
...
URL = "https://g-one.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://g-one.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://g-one.onrender.com/".format(FQDN)
else:
    URL = "https://g-one.onrender.com/".format(FQDN)
